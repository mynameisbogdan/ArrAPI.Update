...
If you want to work on **ArrAPI.Update**, make sure you have [.NET 10.0 SDK](https://dotnet.microsoft.com/download/dotnet/10.0) installed and [Visual Studio](https://www.visualstudio.com/vs).
